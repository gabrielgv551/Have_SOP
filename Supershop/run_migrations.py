"""
Roda todas as migrations do have-gestor-api contra o banco Supershop.
Substitui automaticamente 'lanzi' por 'supershop' nos INSERTs.

Uso:
  python run_migrations.py "postgresql://postgres:senha@host:5432/Supershop"
"""
...
DB_CONFIG = {
    ...
    "password": os.getenv("SUPERSHOP_PASSWORD", ""),
}
...
def adaptar_sql(sql: str) -> str:
    return sql.replace("'lanzi'", "'supershop'")
...
def main():
    print("=" * 60)
    print("  Migrations → Banco Supershop")
    print("=" * 60)
    ...
    try:
        ...
        print("[OK] Conexão com o banco Supershop estabelecida.\n")
