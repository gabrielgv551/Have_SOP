...
if len(sys.argv) > 1:
    ...
    arquivo = r"C:\Users\HAVE\Desktop\Arquivos\Have I\Supershop\ETL Supershop.xlsx"
...
DB_CONFIG = { # Recomenda-se usar variáveis de ambiente aqui também
    ...
    "password": os.getenv("SUPERSHOP_PASSWORD", "131105Gv"), # A senha deve vir do ambiente
}
